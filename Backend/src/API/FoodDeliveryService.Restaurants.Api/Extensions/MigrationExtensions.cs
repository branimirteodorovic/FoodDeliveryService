...
namespace FoodDeliveryService.Restaurants.Api.Extensions;

internal static class MigrationExtensions
{
    /// <summary>
    /// Applies the module's pending EF Core migrations at startup, as the <c>fds_restaurants_owner</c>
    ...
    {
        app.ApplyMigration<RestaurantsDbContext>();
    }
}
