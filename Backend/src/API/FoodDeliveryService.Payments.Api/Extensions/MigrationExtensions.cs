...
namespace FoodDeliveryService.Payments.Api.Extensions;

internal static class MigrationExtensions
{
    /// <summary>
    /// Applies the module's pending EF Core migrations at startup, as the <c>fds_payments_owner</c>
    ...
    {
        app.ApplyMigration<PaymentsDbContext>();
    }
}
