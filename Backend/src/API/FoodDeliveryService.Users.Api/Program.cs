...
builder.Services.AddApiDocumentation(builder.Configuration, ApiDocumentation.Users);
...
// The OpenAPI document and the two UIs over it, at /docs/users/{openapi,scalar,swagger}
