...
namespace FoodDeliveryService.Delivery.Api.Extensions;

internal static class MigrationExtensions
{
    /// <summary>
    /// Applies the module's pending EF Core migrations at startup, as the <c>fds_delivery_owner</c>
    ...
    {
        app.ApplyMigration<DeliveryDbContext>();
    }
}
