...
builder.Services.AddApiDocumentation(builder.Configuration, ApiDocumentation.Delivery);
...
// The OpenAPI document and the two UIs over it, at /docs/delivery/{openapi,scalar,swagger}
