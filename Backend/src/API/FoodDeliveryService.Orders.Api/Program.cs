...
builder.Services.AddApiDocumentation(builder.Configuration, ApiDocumentation.Orders);
...
// The OpenAPI document and the two UIs over it, at /docs/orders/{openapi,scalar,swagger}
