...
namespace FoodDeliveryService.Modules.Notifications.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql = 
            ...
            SELECT EXISTS(
                SELECT 1
                FROM notifications.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO notifications.outbox_message_consumers(outbox_message_id, name)
